...
import { Vinyl, Sparkle, Spring, Arches, Blob, Checker, Pill } from "../Doodles";
...
export default function TopTechSection() {
  return (
    ...
    >
      ...
      {/* gradient-mesh blob bleeding in, screen-blended */}
      <span aria-hidden className="mesh blend-multiply clip-blob pointer-events-none absolute -right-16 top-[46%] hidden h-72 w-72 opacity-60 lg:block" />
      <div aria-hidden className="halftone-fade pointer-events-none absolute left-[6%] bottom-[6%] h-44 w-52 text-[#4100F5]/40" />
      <span
        aria-hidden
      ...
      <Checker data-float className="absolute bottom-[26%] left-[5%] hidden h-12 w-12 rotate-6 text-[#4100F5] md:block" />
      <Pill data-float className="absolute right-[16%] top-[8%] hidden text-[#FF6437] lg:block" />
